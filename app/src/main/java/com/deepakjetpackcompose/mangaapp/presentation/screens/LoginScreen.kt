    ...
    LaunchedEffect(authState.value) {
        if (authState.value == AuthState.Authenticated) {
            navController.navigate(NavigationHelper.MyApp.route) {
                popUpTo(NavigationHelper.Login.route) { inclusive = true }
            }
        }
    }
            ...
            Column(
                ...
                Button(
                    onClick = {
                        ...
                        } else Toast.makeText(context, "fill all the fields", Toast.LENGTH_SHORT)
                            .show()
                    },
                    modifier = Modifier
                        .fillMaxWidth()
                ...
                Row(
                    ...
                    Text(
                        ...
                        modifier = Modifier.clickable(onClick = {
                            navController.navigate(NavigationHelper.SignUp.route)
                        })
                    )
                }
            }
